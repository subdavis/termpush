...
class MsgGen:
    ...
    def __init__(self, mustPackProtocol):
        self.data = {}
        self.mustPackProtocol = mustPackProtocol
    ...
    def pack(self):
        rtrn = json.dumps(self.data)
        if self.mustPackProtocol:
            rtrn += '\n'
        return rtrn
    def wipe(self):
        self.data = {}
